...
//  - Filter tabs (All / Paid / Pending / Failed / Refunded)
//  - Stats bar (counts + revenue)
//  - Multi-select checkboxes
//  - Hover-reveal View button
//  - Pagination
//  - Dark / Light theme via `dark` prop
//
//  Usage: <OrderTable dark={true} />
// ─────────────────────────────────────────────
  ...
  return (
    ...
    >
          ...
          <tbody>
            ...
            {filtered.length === 0 && (
              <tr>
                <td
                  colSpan={8}
                  style={{ padding: "48px", textAlign: "center", color: c.muted, fontSize: 14 }}
                >
      ...
      >
        ...
        <Pagination current={page} total={3} onChange={setPage} dark={dark} />
      </div>
    </div>
  );
}